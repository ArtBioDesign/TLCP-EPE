...
class CaLM:
    ...
    def __init__(self, args: dict=ARGS, weights_file: Optional[str] = None) -> None:
        ...
        self.model = ProteinBertModel(args, self.alphabet).to(self.device)
